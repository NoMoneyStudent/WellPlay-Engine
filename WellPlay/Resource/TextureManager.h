...
namespace TextureManager
{
	...
	const ManagedTexture* LoadStbiFromFile( const std::wstring& fileName, bool sRGB = false );
	...
	inline const ManagedTexture* LoadStbiFromFile( const std::string& fileName, bool sRGB = false )
	{
		return LoadStbiFromFile(MakeWStr(fileName), sRGB);
	}
